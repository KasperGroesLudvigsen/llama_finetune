...
dataset2 = load_dataset("Mabeck/Danish-SlimOrca")

columns_to_remove = ["original_humans", "original_systems", "original_gpts"]  # List of columns to remove
dataset2 = dataset2.remove_columns(columns_to_remove)

# Rename columns in dataset2 to match dataset1 (or vice versa)
dataset2 = dataset2.rename_column("translated_inputs", "question")
dataset2 = dataset2.rename_column("translated_outputs", "response")
dataset2 = dataset2.rename_column("translated_systems", "system_prompt")
...
trainer = SFTTrainer(
    ...
    args = TrainingArguments(
        ...
        warmup_steps = 5,
        num_train_epochs = 4, # Set this for 1 full training run. OpenAI's default is 4 https://community.openai.com/t/how-many-epochs-for-fine-tunes/7027/5
        #max_steps = 60,
        learning_rate = 2e-4,
